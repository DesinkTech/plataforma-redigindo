Rails.application.routes.draw do
  ...
  get     'admin/students/:id' , to: 'students#show'        , as: 'student' 
  ...
  patch   'admin/students/:id/activate'       , to: 'students#activate'    , as: 'activate_student'
  patch   'admin/students/:id/deactivate'     , to: 'students#deactivate'  , as: 'deactivate_student'
  delete  'admin/students/:id/delete'         , to: 'students#destroy'     , as: 'destroy_student'
